...
const CreateTable = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigate back to the tables list to see the new table
      navigate('/tables');
    } catch (err) {
  ...
  return (
    <div className="create-table">
      ...
      <form onSubmit={handleSubmit}>
        <div className="form-group table-name-input">
          ...
          />
          <div className="form-help-text">Choose a memorable name for your poker table</div>
        </div>
        
        <div className="form-group players-input">
          ...
          <input
            ...
            required
          />
          <div className="form-help-text">Typical poker tables seat 6-9 players</div>
        </div>
        ...
        <div className="form-help-text">Big blind should be 2x the small blind</div>
        ...
        <div className="form-help-text">Minimum should be at least 10x the big blind</div>
        
        <button type="submit" disabled={loading}>
          {loading && <Spinner size="small" />}
          {loading ? 'Creating Table...' : 'Create Poker Table'}
        </button>
      </form>
    </div>
  );
